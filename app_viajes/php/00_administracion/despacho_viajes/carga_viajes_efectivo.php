...
<head>
    ...
    <script>
        ...
        function limpiarFormulario() {
            ...
            document.getElementById('dir_origen_lat').value = '';
            document.getElementById('dir_origen_lng').value = '';
            document.getElementById('dir_destino_lat').value = '';
            document.getElementById('dir_destino_lng').value = '';

            document.getElementById('resultado_distancia').textContent = '0 km';
            document.getElementById('resultado_tiempo').textContent = '0 min';
            document.getElementById('distancia_recorrido').value = '';
            document.getElementById('tiempo_recorrido').value = '';

            document.getElementById('recorridoGuardado').style.display = 'none';
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="text-align:left; margin-bottom:15px;">
                ...
                <button type="button" class="btn btn-danger" onclick="limpiarFormulario()" style="padding:8px 16px; background:#dc3545; color:white; border:none; border-radius:4px; font-weight:bold; cursor:pointer;">
                    🗑️ Limpiar
                </button>
            </div>
            ...
            <form method="POST" class="form-2cols" onsubmit="return validarFormulario()">
                ...
                <input type="hidden" name="id_autorizante" value="0">

                <!-- ================= COLUMNA IZQUIERDA ================= -->
                <div class="col">

                    <div class="form-group">
                        <label>📱 Celular (Escribe y presiona Enter o Tab)</label>
                        <input type="text" name="cel_pasaj" id="cel_pasaj" value="<?= htmlspecialchars($viaje['cel_pasaj'] ?? '') ?>" required placeholder="Ej: 1169356236">
                        <small>Al escribir el celular, los datos del pasajero se cargan automáticamente si existen.</small>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-mapa">
                            <input type="text" id="dir_destino" name="direccion_destino" value="<?= htmlspecialchars($viaje['direccion_destino'] ?? '') ?>" onkeyup="autocomplete(this)" placeholder="Dejar en blanco si no aplica">
