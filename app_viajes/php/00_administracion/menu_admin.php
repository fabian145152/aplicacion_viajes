...
<body>
    ...
    <div>
        <ul>
            ...
            <br>
            <li><a href="seteos/inicio.php">SETEOS DE TIEMPOS (Ajusta el tiempo de los viajes diferidos </a></li>
            <br>
            <li><a href="../contaduria/lista_viajes_completa.php">LISTADO DE VIAJES </a></li>
            <br>
            <li><a href="../contaduria/detalle_de_viajes.php">DETALLE DE VIAJES</a></li>
            <br>
