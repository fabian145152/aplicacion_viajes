...
<body>
    ...
    <div>
        <ul>
            ...
            <br>
            <li><a href="seteos/inicio.php">SETEOS DE TIEMPOS (Ajusta el tiempo de los viajes diferidos <br>&nbsp;&nbsp;&nbsp;&nbsp;y ajusta el tiempo en que los viajes estan al aire para mandar alertas. )</a></li>
            <br>
