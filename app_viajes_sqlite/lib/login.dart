...
class _LoginPageState extends State<LoginPage> {
      ...
      if (response.statusCode == 200) {
        try {
          ...
          if (data['res'] == 'OK') {
            ...
            // 🔥 ESTO ES CLAVE:
            _ubicacionService.iniciar(movil, nombreCompleto);
            _log('🚀 Servicio de ubicación iniciado');
  ...
  @override
  void dispose() {
    // 🔥 NO detener el servicio acá
    // (si lo hacemos, se detiene apenas navega a BotonCoordenadas)
