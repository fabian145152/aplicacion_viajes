...
class ViajeCard extends StatelessWidget {
  ...
  const ViajeCard({super.key, required this.viaje, required this.onAceptar});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(
              Icons.phone,
              viaje['cel_pasaj']?.toString() ?? 'Sin celular',
            ),
            const SizedBox(height: 4),
            ...
            _buildInfoRow(
              Icons.location_on,
              viaje['direccion_destino'] ?? 'Sin destino',
            ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            Icon(esDiferido ? Icons.schedule : Icons.check_circle, size: 20),
            const SizedBox(width: 8),
            Text(
